  ...
  const fetchBookings = async () => {
    try {
      ...
      const res = await axios.get(
        `${BASE_URL_ADMIN}/booking-stats?page=${page}&limit=${limit}`,
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-white/5">
              ...
              {bookings.length === 0 && (
                ...
                <tr>
                  <td colSpan="9" className="text-center py-6 text-zinc-500 dark:text-zinc-400">
                    No Bookings Found
                  </td>
                </tr>
              ...
              {bookings.map((booking) => {
                ...
                return (
                  ...
                  <tr key={booking._id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/40">
